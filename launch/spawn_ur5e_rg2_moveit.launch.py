...
def generate_launch_description():
    ...
    # --- share dirs ---
    uryt_share     = get_package_share_directory("ur5e_rg2")
    ...
    # --- MoveIt config ---
    joint_controllers_file = os.path.join(uryt_share, "config", "ur5e_controllers_gripper.yaml")
    moveit_config = (
        MoveItConfigsBuilder("custom_robot", package_name="ur5e_rg2_moveit_config")
        .robot_description(
    ...
    rviz_cfg = os.path.join(get_package_share_directory("ur5e_rg2_moveit_config"),
                            "config", "moveit.rviz")
    rviz = Node(
